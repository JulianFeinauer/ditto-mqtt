...
public class Plc4XMqttProducerMqtt {
...
//        final Configuration configuration = mapper.readValue(new File("src/main/resources/config.json"), Configuration.class);
        ...
        configuration.setDitto(new DittoConfig("org.pragmaticindustries", "mbconnect-poc-2", "demo"));
        configuration.setMqtt(new MqttConfiguration("172.16.0.200", 1883, "", ""));
        configuration.setPlc(new PlcConfig(1000, "s7://192.168.1.1/0/0", Collections.singletonMap("position", "%DB444:0.0:REAL")));
